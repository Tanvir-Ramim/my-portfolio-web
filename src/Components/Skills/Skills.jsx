    ...
    <div id="skill" className="max-w-[1300px] mx-auto  lg:mt-12 md:mt-10 mt-6">
      <div>
        ...
        <p className="md:text-[20px] text-[17px] text-center  mt-3 leading-8 text-[#F2F3F494]">
          Here are some of my skills on which I have been working on for <br />{" "}
          the past 1 year
        </p>
      </div>
      {/* card */}
      <div className="flex lg:mt-8   lg:p-2 md: p-16   lg:flex-row flex-col lg:justify-between w-full gap-10 items-center ">
        ...
        <div className=" shadow-md shadow-blue-800  flex-1 w-fit rounded-2xl border border-[#854CE6] p-7">
          <h1 className="font-semibold text-[28px] mb-5 text-center text-[#F2F3F494]">
            Frontend
          </h1>
          <div className="flex flex-wrap   w-fit  items-center justify-center gap-5">
            <div className="border border-[#F2F3F494] px-6 py-3 w-[173px] rounded-xl ">
              <h1 className="flex justify-center  gap-2 text-[16px] font-medium  text-[#F2F3F494]">
                {" "}
                <img
                  className="w-7 "
            ...
            <div className="border  border-[#F2F3F494] w-[173px] px-6 py-3 rounded-xl  ">
              <h1 className="flex items-center  justify-center  gap-2 text-[16px] font-medium  text-[#F2F3F494]">
                {" "}
                <img
                  className="w-6 h-7 "
            ...
            <div className="border border-[#F2F3F494] w-[173px] px-6 py-3 rounded-xl ">
              <h1 className="flex justify-center items-center   gap-2 text-[16px] font-medium  text-[#F2F3F494]">
                {" "}
                <img
                  className="w-6 h-7 "
          ...
          <div className=" flex flex-wrap w-fit  items-center justify-center gap-5 ">
            <div className="border border-[#F2F3F494] w-[173px] px-6 py-3 rounded-xl ">
              <h1 className="flex items-center justify-center   gap-2 text-[16px] font-medium  text-[#F2F3F494]">
                ...
                <img
                  className="w-6 h-6 "
                  src="https://img.icons8.com/fluent/512/typescript.png"
                  alt=""
                />
                Typescript
              </h1>
            ...
            <div className="border w-[173px] border-[#F2F3F494] px-6 py-3 rounded-xl ">
              <h1 className="flex  gap-2 text-[16px] justify-center font-medium  text-[#F2F3F494]">
                {" "}
                <img
                  className="w-7"
            ...
            <div className="border border-[#F2F3F494] w-[173px] px-6 py-3 rounded-xl ">
              <h1 className="flex items-center  justify-center  gap-2 text-[16px] font-medium  text-[#F2F3F494]">
                ...
                <img
                  className="w-6 h-6 "
                  src="https://www.shutterstock.com/image-vector/mongoose-icon-vector-sign-on-260nw-1329781898.jpg"
                  alt=""
                />
                 Mongoose
              </h1>
