...
const Navbar = () => {
  ...
  <a href='https://github.com/Tanvir-Ramim' target="_blank" rel="noopener noreferrer" className="border py-2 px-4 rounded-3xl text-base font-semibold btn-outline hover:bg-[#854CE6] text-[#854CE6] border-[#854CE6]">
  GitHub Profile
</a>
  </div>
</div>
