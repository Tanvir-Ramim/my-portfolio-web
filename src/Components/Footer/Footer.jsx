...
const Footer = () => {
    return (
        <div className="footerStyle max-w-[1300px] mx-auto p-2 lg:mt-16 md:mt-10 mt-6 ">
            <footer className="footer items-center p-4 bg-[#191924] text-neutral-content">
  <aside className="items-center grid-flow-col">
    ...
    <p>Copyright © 2023 Tanvir Hossan Ramim - All right reserved</p>
  </aside> 
  <nav className="grid-flow-col gap-4 md:place-self-center md:justify-self-end">
    <h1 className="text-lg font-semibold ">SOCIAL</h1>
    <a href='https://www.facebook.com/profile.php?id=100004130149188' target="_blank" rel="noopener noreferrer"  className="text-2xl cursor-pointer">
    <FaFacebookSquare />
    </a>
    <a  href='https://www.linkedin.com/in/tanvir-hossan-ramim-64a5072a0' target="_blank" rel="noopener noreferrer" className="text-2xl cursor-pointer">
    <FaLinkedin />
    </a>
    <a  href='https://www.instagram.com/tanvir.ramim' target="_blank" rel="noopener noreferrer" className="text-2xl cursor-pointer"> <FaInstagram /></a>
  </nav>
</footer>
        </div>
    );
